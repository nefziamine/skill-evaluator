...
public class AiService {
    ...
    public List<Question> generateQuestions(String skill, String difficulty, int count) {
        ...
        String prompt = String.format(
                "Generate exactly %d technical multiple-choice questions for the skill '%s' with difficulty level '%s'. "
                        + "Return ONLY a JSON array of objects with these fields: "
                        + "\"text\" (the question), \"options\" (4 comma-separated options), \"correctAnswer\" (the exact text), \"points\" (integer). "
